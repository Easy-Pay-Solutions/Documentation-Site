...
As an example, if want to find settled ACH transactions made in January 2025 made using Verifone card readers, you can call [ach-transactions.md](../../api-reference/rest-api/query/ach-transactions.md "mention").
