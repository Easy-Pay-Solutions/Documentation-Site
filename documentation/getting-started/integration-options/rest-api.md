...
An example of using [<mark style="color:green;">`Query_Transaction`</mark>](../../../api-reference/rest-api/query.md#apicardprocrest-v1.0.0-query-transaction) method.
...
An example of using [<mark style="color:green;">`Query_ConsentGeneral`</mark>](../../../api-reference/rest-api/query.md#apicardprocrest-v1.0.0-query-consentgeneral) method.
