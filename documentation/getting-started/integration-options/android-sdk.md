...
* `ChargeCreditCardResult`
  * \[See fields listed in the REST API reference - [Process a manual card sale](../../../api-reference/rest-api/query.md#apicardprocrest-v1.0.0-query-consentannual)]
...
* `ListAnnualConsentsResult`
  * \[See fields listed in the REST API reference - [Query annual consent](../../../api-reference/rest-api/query.md#apicardprocrest-v1.0.0-query-consentannual_fulldetail)]
