...
* [REST API](api-reference/rest-api/README.md)
  ...
  * [Consent Annual Older](api-reference/rest-api/consent-annual/README.md)
...
* [REST API Alt](api-reference/rest-api-alt/README.md)
  ...
  * [Consent Annual](api-reference/rest-api/consent-annual-1/README.md)
    * [Calculate surcharging or convenience fees](api-reference/rest-api/consent-annual-1/calculate-surcharging-or-convenience-fees.md)
    * [Cancel a consent (Card On File)](api-reference/rest-api/consent-annual-1/cancel-a-consent-card-on-file.md)
    * [Charge a stored card](api-reference/rest-api/consent-annual-1/charge-a-stored-card.md)
    * [Modify an annual consent](api-reference/rest-api/consent-annual-1/modify-an-annual-consent.md)
    * [Create Annual Consent](api-reference/rest-api/consent-annual-1/create-annual-consent.md)
    * [Create an annual consent with manual card entry](api-reference/rest-api/consent-annual-1/create-an-annual-consent-with-manual-card-entry.md)
