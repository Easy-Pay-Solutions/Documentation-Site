...
To send a payment reminder using the REST API, use the [#apicardprocrest-v1.0.0-other-smspay](../../api-reference/rest-api-alt/text-to-pay.md#apicardprocrest-v1.0.0-other-smspay "mention")endpoint.
