...
* [REST API Alt](api-reference/rest-api-alt/README.md)
  ...
  * [Consent Annual](api-reference/rest-api-alt/consent-annual/README.md)
    * [Calculate surcharging or convenience fees](api-reference/rest-api-alt/consent-annual/calculate-surcharging-or-convenience-fees.md)
    * [Cancel a consent (Card On File)](api-reference/rest-api-alt/consent-annual/cancel-a-consent-card-on-file.md)
    * [Charge a stored card](api-reference/rest-api-alt/consent-annual/charge-a-stored-card.md)
    * [Modify an annual consent](api-reference/rest-api-alt/consent-annual/modify-an-annual-consent.md)
    * [Create Annual Consent](api-reference/rest-api-alt/consent-annual/create-annual-consent.md)
    * [Create an annual consent with manual card entry](api-reference/rest-api-alt/consent-annual/create-an-annual-consent-with-manual-card-entry.md)
